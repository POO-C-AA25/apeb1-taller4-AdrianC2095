...
class Cliente {
    ...
    public String toString() {
        return "Cliente: " + nombre + ", Ejercicio: " + tipoEjercicio + ", Duracion: " + duracion + " min, Completo: " + cumplioRutina;
    }
}
 ...
 * Cliente: Juan Perez, Ejercicio: Cardio, Duracion: 45 min, Completo: true
 * Cliente: Ana Gomez, Ejercicio: Fuerza, Duracion: 30 min, Completo: false
 * Clientes que completaron la rutina: 1
 * Promedio de tiempo invertido: 37.5 min
